...
export declare function last(nodeList: Tree.Node[]): Tree.Node | undefined;
...
export declare function reconstruct(parts: any): Tree.Node;
export declare function merge(n1: Tree.Node, n2: Tree.Node): void;
export declare function hasBranching(node: Tree.Node, maxDepth: number): boolean;
export declare function mainlineNodeList(from: Tree.Node): Tree.Node[];
